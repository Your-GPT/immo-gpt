document.addEventListener('DOMContentLoaded', function() {
  ...
  widgetButtons.innerHTML = `
    ...
    <button class="cb-widget-button" onclick="window.location.href='tel:+493089616928';">
    ...
    <button class="cb-widget-button" onclick="window.location.href='mailto:info@mochow-immobilien.de';">
  ...
  dfMessenger.setAttribute('chat-title', 'MochowGPT');
  dfMessenger.setAttribute('agent-id', 'bde22d8a-8c2d-494c-86b8-3e4ca4291464');
  ...
  script.onload = function() {
    ...
    searchWidget.setAttribute('configId', '502378bd-57f4-4248-aa10-26ef7de0b08e');
    ...
    if (socialIcons) {
      popup.innerHTML += `
        <div class="social-icons">
          <a href="https://www.instagram.com/mochow_immobilien/" target="_blank">
          ...
          <a href="https://www.facebook.com/mochowimmobilien/" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
              <path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"/>
            </svg>
          </a>
          <a href="https://www.youtube.com/@MochowImmobilien" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
              <path d="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z"/>
            </svg>
          </a>
          <a href="https://www.linkedin.com/company/mochow-immobilien/" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
